...
namespace shareDoor.Models
{
    ...
    public class RegisterViewModel
    {
        ...
        [Required(ErrorMessage = "Το πεδίο Κωδικός απαιτείται.")]
        [StringLength(100, ErrorMessage = "Ο κωδικός πρέπει να περιέχει πάνω από {2} χαρακτήρες.", MinimumLength = 6)]
        [DataType(DataType.Password)]
        [Display(Name = "Κωδικός")]
        public string Password { get; set; }

        [Required(ErrorMessage = "Το πεδίο Επαλήθευση κωδικού απαιτείται.")]
        [DataType(DataType.Password)]
